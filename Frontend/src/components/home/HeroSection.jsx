  ...
  return (
    <section className="relative flex flex-col md:flex-row items-center justify-between  lg:pl-16 xl:pl-32   h-[90vh] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col justify-center lg:justify-end  lg:bottom-36  text-center  lg:text-left h-full relative z-10 ">
        ...
        <div className=" md:text-[92px] sm:text-6xl text-4xl font-sorts-mill-gloudy leading-none  lg:text-black text-white !font-thin">
          Shine Bright <br /> With Aurora<span className="  text-primary">.</span>
        </div>
        <p className="mt-4 text-[22px] italic font-sorts-mill-gloudy font-extralight lg:text-black-light text-white">
          Every day is your special day with our fine jewelry!
        </p>
         <button className="w-fit mt-8 px-6 py-3 bg-primary-dark text-white font-medium hover:bg-primary transition mx-auto lg:mx-0">
           — Shop
         </button>
      ...
      <div className="hidden lg:flex flex-1 relative justify-center md:justify-end w-full md:w-1/2 h-full">
        <div className="relative w-full h-full flex items-center justify-center">
          ...
          ></div>
           ...
           {/* Second Image - Full Rounded in Left Corner */}
           {/* <div className="absolute top-8 left-8 w-32 h-32 rounded-full overflow-hidden shadow-2xl border-4 border-white z-10">
             <img
               src={heroImage}
           ...
           <div className="absolute bottom-[188px] -left-8 w-60 h-60 rounded-full overflow-visible shadow-lg border-2 border-white z-30">
             <img
               src={heroImage}
               alt="Aurora Jewelry Detail"
           ...
           <div
             className="relative overflow-hidden w-4/5 h-4/5 shadow-2xl rounded-t-full z-20"
           >
             <img
               src={heroImage}
               alt="Aurora Jewelry"
